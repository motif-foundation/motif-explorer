defmodule BlockScoutWeb.TransactionView do
  ...
  def private_transaction?(%Transaction{input: input}) do
    (String.contains?(input.bytes, "U2Fsd")) 
  end
  ...
  def type_suffix(%Transaction{} = transaction) do
    cond do
      private_transaction?(transaction) ->  "private-transaction"
  ...
  @doc """
  Converts a transaction's Wei value to MOTIF and returns a formatted display value.
