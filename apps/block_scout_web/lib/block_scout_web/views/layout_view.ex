defmodule BlockScoutWeb.LayoutView do
  ...
  def logo do
    Keyword.get(application_config(), :logo) || "/images/motif.png"
  end
  ...
  def subnetwork_title do
    Keyword.get(application_config(), :subnetwork) || "Motif Testnet"
  end

  def network_title do
    Keyword.get(application_config(), :network) || "Motif Mainnet"
  end
  ...
  def release_link(version) do
    ...
    if release_link == nil do
      ...
      html_escape(
        {:safe,
         "<a href=\"#{release_link}\" class=\"footer-link\" target=\"_blank\">#{version}</a>"}
      )
    end
  end
